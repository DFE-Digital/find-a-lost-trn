...
RSpec.describe "Matching spec", type: :system do
  it "attempts to match each time the user changes their details", vcr: true do
    ...
    # Enter a new date of birth, expect to see NI page
    when_i_press_change_date_of_birth
    then_i_see_the_date_of_birth_page

    when_i_enter_a_new_date_of_birth
    then_i_see_the_have_ni_page

    # Fix the date of birth, TRN should match again
    when_i_press_back
    then_i_see_the_date_of_birth_page
    ...
    # Enter a new name, expect to see the NI page
    ...
    # Fix the name, TRN should match again
    when_i_press_back
    then_i_see_the_date_of_birth_page
  ...
  def then_i_see_the_check_answers_page
    ...
    expect(page).to have_content("kevin­.e­@example­.com") # NB: This is kevin&shy;.e&shy;@example&shy;.com
  ...
  def when_i_enter_a_new_date_of_birth
    fill_in "Day", with: "02"
    fill_in "Month", with: "01"
    fill_in "Year", with: "1990"
    when_i_press_continue
