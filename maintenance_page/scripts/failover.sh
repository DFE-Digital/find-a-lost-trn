...
TEMP_URL=$(awk '/name:.*cloud/ {print "https://"$2}' ./maintenance_page/manifests/${CONFIG}/ingress_temp_to_main.yml)

echo
echo Maintenance page enabled at main URL
echo Application available for testing at ${TEMP_URL}
